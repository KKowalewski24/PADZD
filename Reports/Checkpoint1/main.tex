...
\begin{document}
    ...
    \section{Cele projektu} \label{project_goals} {
        ...
        \subsection{Klasyfikacja rodzaju lub poziomu przestępstwa} \label{project_goal_1} {
            ...
            W ramach tego etapu przeprowadzony zostanie szereg eksperymentów mających na celu stworzenie klasyfikatora typu przestępstwa (KY\_CD). Jeżeli okaże się to niemożliwe podjęta zostanie próba klasyfikacji poziomu wykroczenia, stanowiącego bardziej ogólną informacje. Klasyfikacja ta będzie odbywała się na podstawie następujących informacji:
            \begin{itemize}
